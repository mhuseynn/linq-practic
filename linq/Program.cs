...
List<Debtor> debtors = new List<Debtor>
{
            ...
            new Debtor("Martin S. Malinowski", DateTime.Parse("January 17, 1992"), "765-599-3573", "MartinSMalinowski@dayrep.com", "3749 Capitol Avenue New Castle, IN 47362", 1816),
...
//var email_list = debtors.Where(deb => deb.Email.EndsWith("rhyta.com") || deb.Email.EndsWith("dayrep.com")).ToList();
...
//var age_list = debtors.Where(deb => DateTime.Now.Year - deb.BirthDay.Year >= 26 && DateTime.Now.Year - deb.BirthDay.Year <= 36).ToList();

//foreach (var item in age_list)
//{
//    Console.WriteLine(item);
//}
//===========================================================================================================================================
...
//var list = debtors.Where(deb => deb.Debt <= 5000).ToList();
...
//var list = debtors.Where(deb => deb.FullName.Length > 18 && (deb.Phone.Contains("2") || (deb.Phone.Count(m=> m == '7') >= 2))).ToList();
//foreach (var item in list)
//{
//    Console.WriteLine(item);
//}
...
//var list = debtors.Where(deb => deb.BirthDay.Month == 12 || deb.BirthDay.Month == 1 || deb.BirthDay.Month == 2).ToList();
//foreach (var item in list)
//{
//    Console.WriteLine(item);
//}
...
var list = debtors
    .Where(deb => deb.Debt > debtors.Average(deb => deb.Debt))
    .OrderBy(deb => deb.FullName) // Sort by family name
    .ThenByDescending(deb => deb.Debt) // Then sort by decreasing debt amount
    .ToList();
//foreach (var item in list)
//{
//    Console.WriteLine(item);
